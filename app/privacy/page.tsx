    ...
    >
      <Sec n="01" title="Who we are">
        <p>
          ...
          information when you visit this website, register for The 3-Day CLAT
          Rank Roadmap, or otherwise interact with our services. By using this
      ...
      <Sec n="02" title="Information we collect">
        ...
        <ul>
          <li>
            <strong>Contact and order details</strong> — your name, email
          ...
          <li>
            <strong>Marketing attribution</strong> — referral and advertising
      ...
      <Sec n="03" title="How we use your information">
        ...
        <ul>
          <li>Deliver the Program — send your Zoom links, reminders, and prep notes.</li>
          <li>Process your payment and provide customer support.</li>
