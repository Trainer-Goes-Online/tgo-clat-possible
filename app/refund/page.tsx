...
export const metadata: Metadata = {
  ...
  description:
    "The 3-Day CLAT Rank Roadmap is free — here's how registration and cancellation work.",
};
...
export default function RefundPage() {
  return (
    <LegalShell
      title="Refund Policy"
      intro="The 3-Day CLAT Rank Roadmap is free to attend, so there's nothing to pay and nothing to refund."
      updated="16 June 2026"
    >
      <Sec n="01" title="It's free — nothing to refund">
        <p>
          Registration for The 3-Day CLAT Rank Roadmap is{" "}
