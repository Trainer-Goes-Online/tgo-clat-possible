    ...
    <div className="page-stage page-light">
      ...
      <div className="wrap">
        ...
        <div className="next">
          ...
          <div className="nrow"><span className="nnum">02</span><p><b>Add the 3 sessions to your calendar</b> so Day 1 doesn&rsquo;t slip past. Foundations start on {WEBINAR.day1Short}.</p></div>
